...
1. **Capturas de pantalla o GIF** del monitor funcionando
2. **Decisiones sobre la TUI** (por qué `rich` o `curses`, layout, etc.)
3. **Lo que aprendiste**: 2-3 párrafos personales sobre lo que descubriste haciendo el TP

### 3. doubts.md (opcional pero bienvenido)
